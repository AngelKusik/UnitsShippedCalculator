...
- 📍 About this repository: UnitsShippedCalculator: It's a repository containing myUnits Shipped Calculator project, which is a windows form application meant to enable the user to enter the number 
of units shipped each day of a week for three different regions. The application then calculates the average number of units shipped per region and overall.
